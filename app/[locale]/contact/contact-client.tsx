...
const translations = {
  en: {
    ...
    pageDesc: "We are here to answer your inquiries and help you improve your website's search engine visibility",
    ...
    responseTimeHighlight: "24 hours",
    responseTimeSuffix: "on business days",
    // Mailchimp error translations
    errorAlreadySubscribed: "You have already contacted us. We will respond soon",
  ...
  ar: {
    ...
    pageDesc: "نحن هنا للإجابة على استفساراتك ومساعدتك في تحسين ظهور موقعك في محركات البحث",
    cardTitle: "أرسل لنا رسالة",
    ...
    responseTimeHighlight: "24 ساعة",
    responseTimeSuffix: "في أيام العمل",
    // Mailchimp error translations
    errorAlreadySubscribed: "لقد تواصلت معنا سابقا\u064B. سنرد عليك قريبا\u064B",
      ...
      <div className="mx-auto px-4 container">
              ...
              {showSuccess ? (
                <div className="text-center space-y-6">
                  ...
                  <div>
                    ...
                    <p className="text-green-700">{t.successDesc}</p>
                  </div>
                  <button
                    onClick={() => {
                      setShowSuccess(false)
                        ...
                        <div id="mc_embed_signup_scroll">
                          ...
                          <div className="mc-field-group">
                            <label htmlFor="mce-EMAIL">
                              {t.emailLabel} <span className="asterisk">*</span>
                            </label>
                            <input
                              type="email"
                              name="EMAIL"
                          ...
                          {/* First Name Field */}
                          <div className="mc-field-group">
                            <label htmlFor="mce-FNAME">{t.nameLabel}</label>
                            <input type="text" name="FNAME" className="text" id="mce-FNAME" placeholder={t.namePlaceholder} />
                          </div>

                          {/* Company/Message Field */}
                          <div className="mc-field-group">
                            <label htmlFor="mce-COMPANY">{t.messageLabel}</label>
                            <input
                              type="text"
                              name="COMPANY"
                              className="text"
        ...
        <div className="mt-12 max-w-2xl mx-auto text-center">
          <p className="text-gray-600">
            {t.responseTime} <strong className="text-webskeet-blue">{t.responseTimeHighlight}</strong> {t.responseTimeSuffix}
          </p>
        </div>
      </div>
    </main>
